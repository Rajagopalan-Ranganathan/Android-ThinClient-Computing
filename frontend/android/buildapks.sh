...
cd ..
cd thin-client-computing
./gradlew assembleDebug
echo "APKs built"
echo "multivnc at: frontend/android/multivnc/app/build/outputs/apk/app-debug.apk"
echo "thin-client-computing at: frontend/android/thin-client-computing/app/build/outputs/apk/app-debug.apk"
