...
//				}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Log.i("Colormode", connection.getColorModel());
		Log.i("password", connection.getPassword());

		Log.i("MultiVNC", "Connect to: "+connection.getAddress()+" port:"+connection.getPort());
		/*
	...
	protected void onPause() {
		...
		Log.i("MultiVNC", "onPause");

		Intent sendIntent = new Intent();
		sendIntent.setAction(Intent.ACTION_SEND);
		sendIntent.putExtra(Intent.EXTRA_TEXT, "disconnected");
		sendIntent.putExtra("name", name);
		sendIntent.setType("text/multivncdisconnect");
		finish();
